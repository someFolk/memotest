...
public abstract class FirestoreDatabaseHolder<T extends DatabaseAdapter>
{
    ...
    protected void init(@NonNull DatabaseHolder holder, @NonNull Class klass)
    {
    ...
    public String firestoreInset(T object)
    {
        isInitialized();

        // Reserve a document in the specified location.
        // This happens because we call .document() and than .set()
        DocumentReference rootRef = holder.getMultiDatabase().getFirestoreInstance().collection(holder.getTableName()).document();
